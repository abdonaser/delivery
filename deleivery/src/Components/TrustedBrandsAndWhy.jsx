...
const TrustedBrandsAndWhy = () => {
  return (
    <>
        ...
        <div className="mainSection-bg">
          <div className="trusted-brands-why  ">
            <section className="trusted-brands">
              ...
              <p>
                Many companies trusted us from around the world. They always
                support us and give us different ideas.
              </p>
              <div className="brands">
                <img src="../Images/HomePage/mclogo.jpeg" alt="McDonald's" />
                <img src="../Images/HomePage/kfc_logo.png" alt="KFC" />
                <img
                  src="../Images/HomePage/burger_king_logo.png"
                  alt="Burger King"
                />
                <img
                  src="../Images/HomePage/pizza_hut_logo.png"
                  alt="Pizza Hut"
                />
                <img
                  src="../Images/HomePage/pringles_logo.png"
                  alt="Pringles"
                />
      ...
      <div className=" trustedSection2 ">
        <div className="mainSection-bg">
          <div className="trusted-brands-why  ">
            <section className="why-we-are-best">
              <h2>Why We Are The Best?</h2>
              <p>
                We will serve you in various ways, which will make your online
                food ordering more reliable.
              </p>
              <div className="features">
                <div className="feature">
                  ...
                  <p>
                    We provide fast delivery services, which is superior and
                    your product caring.
                  </p>
                </div>
                <div className="feature">
